...
!$acc update device (YD%LDIFQL)

!$acc update device (YD%LDISTUR)

!$acc update device (YD%LNEIGE)

!$acc update device (YD%LRNUMX)

!$acc update device (YD%LRNUEXP)

!$acc update device (YD%LRTRUEBBC)

!$acc update device (YD%LRTRUEDIR)
...
!$acc update device (YD%LCVSHCU)

!$acc update device (YD%LCVGQ)

!$acc update device (YD%LPEC)

!$acc update device (YD%LUDEVOL)

!$acc update device (YD%LCDDCSD)

!$acc update device (YD%NCLOMIX)

!$acc update device (YD%NFSIG)

!$acc update device (YD%LHLRADUPD)

!$acc update device (YD%NDPRECPERIOD)

!$acc update device (YD%NDPRECPERIOD2)

!$acc update device (YD%LDPRECIPS)

!$acc update device (YD%LDPRECIPS2)

CALL COPY (YD%YRDPRECIPS)

CALL COPY (YD%YRDVISI)

!$acc update device (YD%CGMIXLEN)

!$acc update device (YD%CGTURS)

!$acc update device (YD%CGTRG)

!$acc update device (YD%LPRGML)

!$acc update device (YD%LCVRA)

!$acc update device (YD%LCVTDK)

!$acc update device (YD%LDAYD)

!$acc update device (YD%LCVPRO)

!$acc update device (YD%LGRAPRO)

!$acc update device (YD%LCDDPRO)

!$acc update device (YD%LCVCSD)

!$acc update device (YD%LUSL)

!$acc update device (YD%LNSDO)
...
!$acc update device (YD%LCVTURB)

!$acc update device (YD%LNEBRIC)
...
!$acc update device (YD%LCAMOD)

!$acc update device (YD%LCOMOD)
...
!$acc update device (YD%NTEND_DIAG_POS)

!$acc update device (YD%NTEND_DIAG_FREQ_RESET)
